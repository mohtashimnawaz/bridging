...
export interface MyTokenOFTAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SEND"
      | "SEND_AND_CALL"
...
export interface MyTokenOFTAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): MyTokenOFTAdapter;
  waitForDeployment(): Promise<this>;

  interface: MyTokenOFTAdapterInterface;
